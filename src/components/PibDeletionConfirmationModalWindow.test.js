...
describe('PibDeletionConfirmationModalWindow', () => {
  ...
  test('renders correctly when visible', () => {
    render(<PibDeletionConfirmationModalWindow visible={true} onClose={onClose} onConfirm={onConfirm} />);
  ...
  test('does not render when not visible', () => {
    const { container } = render(<PibDeletionConfirmationModalWindow visible={false} onClose={onClose} onConfirm={onConfirm} />);
